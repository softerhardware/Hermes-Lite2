...
set_output_delay -clock clock_76p8MHz -max 3 [get_ports {io_lvds_txp}]
set_output_delay -clock clock_76p8MHz -min 2 [get_ports {io_lvds_txp}]
set_output_delay -clock clock_76p8MHz -max 3 [get_ports {io_lvds_txn}]
set_output_delay -clock clock_76p8MHz -min 2 [get_ports {io_lvds_txn}]
set_input_delay -clock clock_76p8MHz -max 3 [get_ports {io_lvds_rxp}]
set_input_delay -clock clock_76p8MHz -min 2 [get_ports {io_lvds_rxp}]
