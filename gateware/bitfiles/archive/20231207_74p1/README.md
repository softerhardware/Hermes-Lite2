...
## 20231207_74p1 Testing Release

This is a testing release for this changes:

* Tx Inhibit (from CN8) is propagated back to the SDR software using Bit1 of the C&C packet bits

This test release contains only the RBF files for the usual variants, as well as the main variant hl2b5up_main.
