...
U 1 1 578473DC
P 3225 5975
F 0 "#PWR0179" H 3225 5725 50  0001 C CNN
...
U 1 1 5785175F
P 3225 5225
F 0 "#PWR0180" H 3225 5075 50  0001 C CNN
...
U 1 1 5785299C
P 3475 5375
F 0 "#PWR0181" H 3475 5125 50  0001 C CNN
...
U 1 1 5785B361
P 6100 975
F 0 "#PWR0182" H 6100 825 50  0001 C CNN
...
U 1 1 57861403
P 4775 3100
F 0 "#PWR0183" H 4775 2850 50  0001 C CNN
...
U 1 1 578618BD
P 4600 3300
F 0 "#PWR0184" H 4600 3050 50  0001 C CNN
...
U 1 1 57864AD2
P 4775 4225
F 0 "#PWR0185" H 4775 3975 50  0001 C CNN
...
U 1 1 57864AD8
P 4600 4400
F 0 "#PWR0186" H 4600 4150 50  0001 C CNN
...
U 1 1 5786643A
P 5125 3500
F 0 "#PWR0187" H 5125 3250 50  0001 C CNN
...
U 1 1 578678D9
P 4750 2275
F 0 "#PWR0188" H 4750 2025 50  0001 C CNN
...
U 1 1 57879272
P 6750 3450
F 0 "#PWR0189" H 6750 3200 50  0001 C CNN
...
U 1 1 58023060
P 9125 2025
F 0 "RF2" H 9125 2175 50  0000 C CNN
F 1 "SMA" H 9325 2050 50  0000 C CNN
F 2 "HERMESLITE:SMAEDGE_TH_R" H 9125 2025 50  0001 C CNN
F 3 "" H 9125 2025 50  0000 C CNN
F 4 "HAND" H 9300 2175 39  0000 C CNN "Option"
...
U 1 1 5802335F
P 9125 2250
F 0 "#PWR0190" H 9125 2000 50  0001 C CNN
...
U 1 1 58025686
P 7325 2125
F 0 "#PWR0191" H 7325 1975 50  0001 C CNN
...
F 4 "PATR" H 7375 2350 60  0001 C CNN "Option"
	1    7375 2350
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 58026DD8
P 7375 2475
F 0 "#PWR0192" H 7375 2225 50  0001 C CNN
...
U 1 1 58037FA1
P 8375 5550
F 0 "#PWR0193" H 8375 5550 30  0001 C CNN
...
U 1 1 58037FA7
P 7725 5675
F 0 "#PWR0194" H 7725 5675 30  0001 C CNN
...
External PTT\nWill ground pin 1 \nduring TX
Text Notes 7475 1275 0    60   ~ 0
No onboard TR relay in default build\nFor onboard TR, remove J14 and install at J1, install K2 
...
F 4 "HAND" H 8050 1975 39  0000 C CNN "Option"
	1    8050 2025
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 580E97CB
P 7850 2475
F 0 "#PWR0195" H 7850 2225 50  0001 C CNN
...
U 1 1 58173FC5
P 5950 2025
F 0 "#PWR0197" H 5950 1775 50  0001 C CNN
...
U 1 1 5919A4C2
P 2275 6100
F 0 "#PWR0198" H 2275 5850 50  0001 C CNN
...
U 1 1 591F92E3
P 5450 1600
F 0 "#PWR0199" H 5450 1350 50  0001 C CNN
...
U 1 1 59209ADC
P 6225 1275
F 0 "#PWR0200" H 6225 1025 50  0001 C CNN
...
U 1 1 59254DE1
P 7725 5050
F 0 "#PWR0201" H 7725 5050 30  0001 C CNN
...
U 1 1 5927546A
P 3625 3575
F 0 "#PWR0202" H 3625 3325 50  0001 C CNN
...
U 1 1 5927603D
P 3625 4675
F 0 "#PWR0203" H 3625 4425 50  0001 C CNN
...
U 1 1 592783C9
P 3875 6100
F 0 "#PWR0204" H 3875 5850 50  0001 C CNN
...
U 1 1 5938ECBB
P 4525 5125
F 0 "#PWR0205" H 4525 4975 50  0001 C CNN
...
U 1 1 593B091D
P 8375 4925
F 0 "#PWR0206" H 8375 4675 50  0001 C CNN
...
F 4 "HV" H 4350 2125 60  0001 C CNN "Ext"
	1    4350 2125
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 59F2E63B
P 8000 6550
F 0 "#PWR0207" H 8000 6300 50  0001 C CNN
...
U 1 1 59F2E641
P 8000 6125
F 0 "#PWR0208" H 8000 5975 50  0001 C CNN
...
U 1 1 59F2E64F
P 7600 6300
F 0 "#PWR0209" H 7600 6050 50  0001 C CNN
...
U 1 1 59F6E419
P 6525 2475
F 0 "#PWR0210" H 6525 2475 39  0001 C CNN
...
U 1 1 59F8B642
P 8450 2525
F 0 "J14" V 8375 2525 39  0000 C CNN
